...
exports.ConfirmacionPlanMensualComponent = void 0;
const core_1 = require("@angular/core");
const router_1 = require("@angular/router");
const common_1 = require("@angular/common");
let ConfirmacionPlanMensualComponent = (() => {
    let _classDecorators = [(0, core_1.Component)({
            selector: 'app-confirmacion-plan-mensual',
            standalone: true,
            imports: [router_1.RouterLink, common_1.CommonModule, common_1.DatePipe],
    ...
    let _classThis;
    var ConfirmacionPlanMensualComponent = _classThis = class {
        constructor() {
    ...
    __setFunctionName(_classThis, "ConfirmacionPlanMensualComponent");
    (() => {
        const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
        __esDecorate(null, _classDescriptor = { value: _classThis }, _classDecorators, { kind: "class", name: _classThis.name, metadata: _metadata }, null, _classExtraInitializers);
        ConfirmacionPlanMensualComponent = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return ConfirmacionPlanMensualComponent = _classThis;
})();
exports.ConfirmacionPlanMensualComponent = ConfirmacionPlanMensualComponent;
