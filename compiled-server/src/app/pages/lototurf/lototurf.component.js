...
exports.LototurfComponent = void 0;
...
let LototurfComponent = (() => {
    ...
    var LototurfComponent = _classThis = class extends _classSuper {
        ...
        generateBasicPrediction() {
            ...
            this.predictionResult = null;
            this.predictionError = null;
            console.log('Generando predicción básica para Lototurf...');
            // Llamar al servicio de predicciones
            if (this.predictionService) {
                this.predictionService.generatePrediction('lototurf').subscribe({
                    next: (response) => {
    ...
    __setFunctionName(_classThis, "LototurfComponent");
    (() => {
        const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(_classSuper[Symbol.metadata] ?? null) : void 0;
        __esDecorate(null, _classDescriptor = { value: _classThis }, _classDecorators, { kind: "class", name: _classThis.name, metadata: _metadata }, null, _classExtraInitializers);
        LototurfComponent = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return LototurfComponent = _classThis;
})();
exports.LototurfComponent = LototurfComponent;
