...
exports.ConfirmacionPlanProComponent = void 0;
const core_1 = require("@angular/core");
const router_1 = require("@angular/router");
const common_1 = require("@angular/common");
let ConfirmacionPlanProComponent = (() => {
    ...
    let _classThis;
    var ConfirmacionPlanProComponent = _classThis = class {
        constructor() {
    ...
    __setFunctionName(_classThis, "ConfirmacionPlanProComponent");
    (() => {
        const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
        __esDecorate(null, _classDescriptor = { value: _classThis }, _classDecorators, { kind: "class", name: _classThis.name, metadata: _metadata }, null, _classExtraInitializers);
        ConfirmacionPlanProComponent = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return ConfirmacionPlanProComponent = _classThis;
})();
exports.ConfirmacionPlanProComponent = ConfirmacionPlanProComponent;
