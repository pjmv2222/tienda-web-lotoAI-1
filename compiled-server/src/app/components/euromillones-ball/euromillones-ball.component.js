...
exports.EuromillonesBallComponent = void 0;
...
class WebGLContextManager {
    constructor() {
        ...
        this.MAX_CONTEXTS = 40; // Aumentamos el límite para permitir más bolas simultáneas
        this.staticImageCache = new Map(); // Cache de imágenes estáticas
        this.contextPriorities = new Map(); // Prioridades de los contextos
        this.lastContextId = 0; // Para generar IDs únicos de contextos
    ...
    static getInstance() {
        if (!WebGLContextManager.instance) {
            ...
            window.WebGLContextManager = WebGLContextManager.instance;
        }
...
let EuromillonesBallComponent = (() => {
    ...
    let _classThis;
    let _ballContainer_decorators;
    let _ballContainer_initializers = [];
    let _ballContainer_extraInitializers = [];
    ...
    let _staticRendering_decorators;
    let _staticRendering_initializers = [];
    let _staticRendering_extraInitializers = [];
    let _customColor_decorators;
    let _customColor_initializers = [];
    let _customColor_extraInitializers = [];
    var EuromillonesBallComponent = _classThis = class {
        constructor(cdr, elementRef) {
            this.cdr = cdr;
            this.elementRef = elementRef;
            this.ballContainer = __runInitializers(this, _ballContainer_initializers, void 0);
            this.number = (__runInitializers(this, _ballContainer_extraInitializers), __runInitializers(this, _number_initializers, ''));
            this.type = (__runInitializers(this, _number_extraInitializers), __runInitializers(this, _type_initializers, 'regular')); // regular o star
            this.size = (__runInitializers(this, _type_extraInitializers), __runInitializers(this, _size_initializers, 80));
            this.priority = (__runInitializers(this, _size_extraInitializers), __runInitializers(this, _priority_initializers, 0)); // 0 = baja, 1 = media, 2 = alta
            this.staticRendering = (__runInitializers(this, _priority_extraInitializers), __runInitializers(this, _staticRendering_initializers, false)); // Renderizado estático para evitar problemas de contexto WebGL
            this.customColor = (__runInitializers(this, _staticRendering_extraInitializers), __runInitializers(this, _customColor_initializers, '')); // Color personalizado para diferentes juegos de lotería
            // Propiedades para el modo estático
            this.useStaticImage = (__runInitializers(this, _customColor_extraInitializers), false);
        ...
        createStaticImageImmediately() {
            ...
            const gradient = ctx.createRadialGradient(center - ballRadius * 0.3, center - ballRadius * 0.3, 0, center, center, ballRadius);
            ...
            const whiteGradient = ctx.createRadialGradient(center - whiteCircleRadius * 0.2, center - whiteCircleRadius * 0.2, 0, center, center, whiteCircleRadius);
        ...
        generateStaticImage(cacheKey) {
            ...
            try {
                ...
                const gradient = textureContext.createRadialGradient(textureSize * 0.3, textureSize * 0.3, textureSize * 0.1, textureSize * 0.5, textureSize * 0.5, textureSize * 0.9);
                ...
                const drawNumberCircle = (x, y) => {
                    // Dibujar círculo blanco
                    textureContext.save();
                    textureContext.beginPath();
                    textureContext.ellipse(x, y, circleRadius, circleRadius * verticalSquash, 0, 0, Math.PI * 2);
                    // Usar un gradiente para el círculo blanco para dar más realismo
                    const circleGradient = textureContext.createRadialGradient(x - circleRadius * 0.2, y - circleRadius * 0.2, 0, x, y, circleRadius);
                ...
                textureContext.save();
                textureContext.beginPath();
                textureContext.ellipse(textureSize / 2, textureSize / 2, mainCircleRadius, mainCircleRadius * verticalSquash, 0, 0, Math.PI * 2);
                // Gradiente para el círculo central
                const mainCircleGradient = textureContext.createRadialGradient(textureSize / 2 - mainCircleRadius * 0.2, textureSize / 2 - mainCircleRadius * 0.2, 0, textureSize / 2, textureSize / 2, mainCircleRadius);
        ...
        createBall() {
            ...
            const gradient = textureContext.createRadialGradient(textureSize * 0.3, // x0 - punto inicial x (desplazado para efecto de luz)
            ...
            const drawNumberCircle = (centerX, centerY) => {
                textureContext.save();
                ...
                const circleGradient = textureContext.createRadialGradient(-circleRadius * 0.2, -circleRadius * 0.2, 0, 0, 0, circleRadius);
                circleGradient.addColorStop(0, '#FFFFFF');
                circleGradient.addColorStop(1, '#F0F0F0');
                textureContext.fillStyle = circleGradient;
                textureContext.fill();
    ...
    __setFunctionName(_classThis, "EuromillonesBallComponent");
    (() => {
        const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
        _ballContainer_decorators = [(0, core_1.ViewChild)('ballContainer')];
        _number_decorators = [(0, core_1.Input)()];
        _type_decorators = [(0, core_1.Input)()];
        _size_decorators = [(0, core_1.Input)()];
        _priority_decorators = [(0, core_1.Input)()];
        _staticRendering_decorators = [(0, core_1.Input)()];
        _customColor_decorators = [(0, core_1.Input)()];
        __esDecorate(null, null, _ballContainer_decorators, { kind: "field", name: "ballContainer", static: false, private: false, access: { has: obj => "ballContainer" in obj, get: obj => obj.ballContainer, set: (obj, value) => { obj.ballContainer = value; } }, metadata: _metadata }, _ballContainer_initializers, _ballContainer_extraInitializers);
        ...
        __esDecorate(null, null, _staticRendering_decorators, { kind: "field", name: "staticRendering", static: false, private: false, access: { has: obj => "staticRendering" in obj, get: obj => obj.staticRendering, set: (obj, value) => { obj.staticRendering = value; } }, metadata: _metadata }, _staticRendering_initializers, _staticRendering_extraInitializers);
        __esDecorate(null, null, _customColor_decorators, { kind: "field", name: "customColor", static: false, private: false, access: { has: obj => "customColor" in obj, get: obj => obj.customColor, set: (obj, value) => { obj.customColor = value; } }, metadata: _metadata }, _customColor_initializers, _customColor_extraInitializers);
        __esDecorate(null, _classDescriptor = { value: _classThis }, _classDecorators, { kind: "class", name: _classThis.name, metadata: _metadata }, null, _classExtraInitializers);
        EuromillonesBallComponent = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
    })();
    // Versión de cache para forzar regeneración cuando cambie el aspecto visual
    _classThis.CACHE_VERSION = 'v5-custom-colors';
    (() => {
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return EuromillonesBallComponent = _classThis;
})();
exports.EuromillonesBallComponent = EuromillonesBallComponent;
