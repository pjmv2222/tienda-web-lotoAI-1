...
# Ruta al archivo CSV
ruta_archivo = 'C:\\Users\\Pedro\\Desktop\\LotoIA\\Lototurf\\Histórico-Resultados-Lototurf.csv'

# Definir los nombres de las columnas
nombres_columnas = ['Date', 'Num1', 'Num2', 'Num3', 'Num4', 'Num5', 'Num6', 'Horse']
...
# Si no hay necesidad de manejar datos faltantes específicamente para 'Horse', esta línea se mantiene para asegurar el tipo correcto de las columnas
columnas_numericas = ['Num1', 'Num2', 'Num3', 'Num4', 'Num5', 'Num6', 'Horse']
...
ruta_archivo_guardar = 'C:\\Users\\Pedro\\Desktop\\LotoIA\\Lototurf\\DataFrame_Lototurf.csv'
