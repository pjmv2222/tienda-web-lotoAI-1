...
datos = pd.read_csv(os.path.join(os.path.dirname(__file__), 'DataFrame_Bonoloto.csv'), encoding='utf-8')
...
# Guardar el modelo
model_path = os.path.join(os.path.dirname(__file__), 'modelo_Bonoloto.h5')
...
df.to_csv(os.path.join(os.path.dirname(__file__), 'predicciones-Bonoloto.csv'), index=False)
...
datos.to_csv(os.path.join(os.path.dirname(__file__), 'Bonoloto_Predicciones.csv'), index=False, encoding='utf-8')