...
# Variable para almacenar la fecha del sorteo
fecha_sorteo = None
...
for linea in texto.split('\n'):
    ...
    if match_premio:
        ...
        datos_premios.append({
            "Fecha": fecha_sorteo.strftime('%d/%m/%Y'),  # La fecha se mantiene como texto
            "Premio": int(premio),  # Convertir a entero
            "Euros Billete": int(euros.replace('.', '')),  # Eliminar puntos y convertir a entero
