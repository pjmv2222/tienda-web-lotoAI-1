...
def procesar_pdf(pdf_path):
    with pdfplumber.open(pdf_path) as pdf:
        ...
        for match in patron_premio.finditer(texto_completo):
            ...
            premio_key = (numero_sorteo, euros_int, int(numero))
...
print(df_premios)
df_premios.to_excel(excel_file, index=False)

# Convertir los datos a un DataFrame y guardar en Excel
df_premios = pd.DataFrame(datos_premios)
print(df_premios)
df_premios.to_excel('premios_mayores_completo-1.xlsx', index=False)
