...
/* harmony import */ var _environments_environment__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../../environments/environment */ 28967);
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @angular/core */ 37100);
/* harmony import */ var _services_stripe_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../services/stripe.service */ 30646);
/* harmony import */ var _services_paypal_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../services/paypal.service */ 1252);
...
let PasarelaPagoComponent = /*#__PURE__*/(() => {
...
/* harmony export */ });
/* harmony import */ var C_Users_Pedro_Desktop_Proyec_web_loto_ia_tienda_web_lotoAI_1_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./node_modules/@babel/runtime/helpers/esm/asyncToGenerator.js */ 91941);
/* harmony import */ var _stripe_stripe_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @stripe/stripe-js */ 12442);
/* harmony import */ var _environments_environment__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../environments/environment */ 28967);
...
let StripeService = /*#__PURE__*/(() => {
  class StripeService {
    ...
    confirmCardPayment(clientSecret, cardElement) {
      return (0,rxjs__WEBPACK_IMPORTED_MODULE_4__.from)(this.stripe).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.switchMap)(stripe => {
        if (!stripe) {
          return (0,rxjs__WEBPACK_IMPORTED_MODULE_4__.throwError)(() => new Error('Stripe no ha sido inicializado'));
        }
        return (0,rxjs__WEBPACK_IMPORTED_MODULE_4__.from)(stripe.confirmCardPayment(clientSecret, {
          payment_method: {
            card: cardElement,
            billing_details: {
    ...
    processCardPayment(planId, userId) {
      return this.createPaymentIntent(this.getPlanPrice(planId), planId, userId).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.switchMap)(paymentIntent => {
    ...
    static {
      this.ɵfac = function StripeService_Factory(__ngFactoryType__) {
        return new (__ngFactoryType__ || StripeService)(_angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵinject"](_angular_common_http__WEBPACK_IMPORTED_MODULE_6__.HttpClient));
      };
    }
    static {
...
/* harmony export */ });
/* harmony import */ var _dist_index_mjs__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../dist/index.mjs */ 76495);
